...
from radarpost.web.context import build_routes, RequestContext
...
class RadarTestCase(TestCase):
    ...
    def setUp(self):
        # XXX load it!
        self.config = {'apps': ['radarpost.web.radar_api']}
        self.url_gen = URLGenerator(build_routes(self.config.get('apps', [])), {})
